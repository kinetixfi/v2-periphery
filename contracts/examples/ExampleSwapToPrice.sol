...
contract ExampleSwapToPrice {
    ...
    function swapToPrice(
        ...
        uint256 amountIn;
        {
            (uint256 reserveA, uint256 reserveB) = KinetixV2Library.getReserves(factory, tokenA, tokenB);
            (aToB, amountIn) = KinetixV2LiquidityMathLibrary.computeProfitMaximizingTrade(
                truePriceTokenA,
                truePriceTokenB,
                reserveA,
                reserveB
